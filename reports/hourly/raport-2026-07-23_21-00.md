...
**Okno raportu:** 21:00–22:00 LT
**Zweryfikowane próbki ADS-B wewnątrz Polski:** 1

## Podsumowanie do publikacji

```text
A400M ATLAS "ZM414" RRR4121 | 21:40 LT | trasa: EPRZ → EPRZ [obserwacyjna] | kierunek ADS-B: manewrowanie / mała zmiana
```
...
|---|---|---|---|---|---|---|---|---:|---:|---:|
| A400M Atlas | ZM414 | `RRR4121` | `43C5E8` | 21:40 → 21:40 LT | EPRZ → EPRZ | obserwacyjna | manewrowanie / mała zmiana | 1 | N/A | 0 kt |
